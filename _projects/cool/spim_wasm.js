...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'spim_wasm.data';
      var REMOTE_PACKAGE_BASE = 'spim_wasm.data';
...
var REMOTE_PACKAGE_SIZE = metadata['remote_package_size'];
    ...
    function runWithFS() {
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_spim_wasm.data');

      };
      Module['addRunDependency']('datafile_spim_wasm.data');
    ...
    loadPackage({"files": [{"filename": "/trap.handler", "start": 0, "end": 79625}], "remote_package_size": 79625});
...
var _cool_execute = Module['_cool_execute'] = createExportWrapper('cool_execute');
